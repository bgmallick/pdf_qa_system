        ...
        <div className="flex flex-col h-screen bg-gray-100">
            <header className="bg-white shadow-sm z-10">
                <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    <h1 className="text-lg font-semibold text-gray-900">Spaces | AI Research Assistant</h1>
                </div>
            </header>
                        ...
                        <div className="w-full lg:w-1/3 flex flex-col">
                            <div className="flex-1 min-h-0">
                                <section aria-labelledby="documents-section" className="bg-white rounded-lg shadow p-6 h-full">
                                    <h2 id="documents-section" className="text-lg font-medium text-gray-900 mb-4">Knowledge Base</h2>
                                    <div className="space-y-4">
                                        <FileDropZone
